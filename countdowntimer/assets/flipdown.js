...
var FlipDown = function () {
  ...
  _createClass(FlipDown, [{
    ...
    key: "change",
    value: function change(show1,show2,timerBarBackground,timerBarFont,buttonBackground,buttonFont,timeBackground,timeFont,iconActive) {
      var style=document.createElement('style');
      var change=document.createTextNode(`
        #flipdown{display:${show1}}
        #flipdown2{display:${show2}}
        .flipdown{background:${timerBarBackground};color:${timerBarFont};}
        .flipdown.flipdown__theme-dark .rotor-group-heading:before{color:${timerBarFont};}
        .testButton{background:${buttonBackground};color:${buttonFont}}
        .m-act-del{display:${iconActive}}
        .flipdown.flipdown__theme-dark .rotor-bottom, .flipdown.flipdown__theme-dark .rotor-leaf-rear{color:${timeFont};background:${timeBackground}}
        .flipdown.flipdown__theme-dark .rotor, .flipdown.flipdown__theme-dark .rotor-top, .flipdown.flipdown__theme-dark .rotor-leaf-front{color:${timeFont};background:${timeBackground}}
        .flipdown.flipdown__theme-dark .rotor-bottom, .flipdown.flipdown__theme-dark .rotor-leaf-rear{color:${timeFont};background:${timeBackground}}'
      `)
    ...
    value: function _parseOptions(opt) {
      ...
      return {
        ...
        headings: headings,
        beforetime:opt.beforetime ? opt.beforetime : "",
        aftertime:opt.aftertime ? opt.aftertime : "",
        buttonValue:opt.buttonValue ? opt.buttonValue : "",
        buttonActive:opt.buttonActive ? opt.buttonActive : "",
        iconActive:opt.iconActive ? opt.iconActive : "",
      };
    }
  },{
    key: "_setBeforeMsg",
    value: function _setBeforeMsg(opt) {
      console.log(opt)
      var msg = document.createElement("div");
      msg.innerHTML = opt.beforetime;
    ...
    key: "_setAfterMsg",
    value: function _setAfterMsg(opt) {
      console.log(opt)
      var msg = document.createElement("div");
      msg.classList.add("test");
      msg.textContent = opt.aftertime;
      console.log(msg)
      this.element.appendChild(msg)
    }
  },{
    key: "_setButton",
    value: function _setButton(opt) {
      console.log(opt)
      var msg = document.createElement("div");
      msg.textContent = opt.buttonValue;
      msg.classList.add("testButton");
      console.log(msg)
      this.element.appendChild(msg)
    }
  },{
    key: "_setIcon",
    value: function _setIcon(opt) {
      if(opt.iconActive == "block"){
        var msg = document.createElement("div");
        msg.classList.add("m-act-del");
        this.element.appendChild(msg)
      }
    }
  },{
    ...
    value: function _init() {
      ...
      this._setAfterMsg(this.opts);
      this._setButton(this.opts);
      this._setIcon(this.opts)
